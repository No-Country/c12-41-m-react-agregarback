          ...
          <>
            <div className="">
              ...
              <article className="grid gap-10">
                <h4 className="font-bold text-white">Bienvenido <span className="bg-gradient-to-r from-yellow to-orange text-transparent bg-clip-text">
                 
                </span>{' '} a nuestra plataforma bancaria segura y confiable</h4>
                <div className="grid sm:grid-cols-2">
                  <p className="text-left">
                    Donde podrás acceder fácilmente a la información de tus cuentas financieras. Aquí, te brindamos una visión completa y transparente de tus activos y pasivos, poniendo a tu alcance un panorama claro de tus finanzas personales.
                  </p>
                  <div>
                    <img
