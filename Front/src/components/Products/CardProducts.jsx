const CardProducts = ({ title, description, icon }) => {
    return (
      <div className="relative py-6 px-6 rounded-3xl w-64 my-4 shadow-xl transition duration-300 transform hover:scale-105">
        <div className="mt-8">
          ...
          <span className="flex items-center justify-center text-[50px]">{icon}</span>
          </div>
