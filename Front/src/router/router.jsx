...
const Proteccion = lazy(() =>
  import("../components/Proteccion/Proteccion.jsx")
);
const ProtectedLayout = lazy(() =>
  import("../components/Layout/Protected/index.jsx")
);
...
const NoProtectedLayout = lazy(() =>
  import("../components/Layout/NoProtected/index.jsx")
);
        ...
        <Route element={<ProtectedLayout />}>
          <Route element={<Proteccion />}>
            ...
            <Route element={<CustomProvider />}>
              ...
              <Route
                path="/investments"
                element={<div>This is investments</div>}
              />
